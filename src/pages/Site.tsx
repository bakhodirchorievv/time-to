...
// import "../styles/Site/SiteResponsive.css";
...
const Site = () => {
	...
	return (
		<>
			<Head>
				<link rel="stylesheet" href="/styles/Site/Site.css" />
			</Head>
			<Head>
				<link rel="stylesheet" href="/styles/Site/SiteResponsive.css" />
			</Head>
			<div className="site-wrapper">
				...
				<div className="first-part">
					...
					<div className="first-body">
						<img
							src="/MainPage/siteFirst.png"
							alt=""
							className="firstBodyImg"
						/>
						<img
							src="/MainPage/siteSecond.png"
							alt=""
							className="firstBodyImg"
						/>
						<img
							src="/MainPage/siteThird.png"
							alt=""
							className="firstBodyImg"
						/>
					</div>
